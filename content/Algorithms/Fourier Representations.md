...
tags:
  - Algoposting
  - Quantum-Algorithms
summary: Introduction to Fourier Representations
status: draft
draft: true
---
...
and 
$$
D |\psi \rangle = \dfrac{1}{\sqrt{N}} \sum_{x \in \{0,1\}^n} (2 \mu - g(x))|x \rangle 
$$
...
> [!Problem]
> Given $f:\{0,1\}^n \rightarrow \{0,1\}$  such that 
> 
> $$ 
> f(x) = ax +b \bmod 2
>  $$ 
> 
> where $a \in \{0,1\}^n$ , $b\in \{0,1\}$ and 
> 
> $$ 
